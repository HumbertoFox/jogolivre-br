...
export default function FooterComponents() {
    ...
    return (
        ...
        >
            <h4
                className='text-2xl text-red-500 text-center py-14 capitalize cursor-default'
                ref={h4Ref}
            >
                Redes Sociais
            </h4>
            <div className='w-full min-h-[640px] flex flex-col sm:flex-row'>
                <div
                    className='w-full min-h-[33.3vh] sm:min-h-full flex items-start justify-center bg-[url("/images/backgroun_footer_0.avif")] bg-cover bg-no-repeat'
                    ref={divFaceRef}
                >
                    <Link
                ...
                <div
                    className='w-full min-h-[33.3vh] sm:min-h-full flex items-start justify-center bg-[url("/images/backgroun_footer_1.avif")] bg-cover bg-no-repeat'
                    ref={divWhatsRef}
                >
                    <Link
                        ...
                        ref={linkWhatsRef}
                    >
                        <FaSquareWhatsapp className="size-7" />
                        Jogo Livre BR
                    </Link>
                </div>
                <div
                    className='w-full min-h-[33.3vh] sm:min-h-full flex items-start justify-center bg-[url("/images/backgroun_footer_2.avif")] bg-cover bg-no-repeat'
                    ref={divTwichRef}
                >
                    <Link
